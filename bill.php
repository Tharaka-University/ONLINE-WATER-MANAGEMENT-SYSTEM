                    ...
                    <div class="invoice overflow-auto">
                        <div style="min-width: 600px">
                            <header>
                                <div class="row">
                                    ...
                                    <div class="col company-details">
                                        ...
                                        <div>191-01000 Marimanti, KENYA</div>
                                        <div>(123) 456-789</div>
                            ...
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        ...
                                        <div class="email"><a style="color:black"
                                                href="tel:+91 <?php echo $customer_phone?>">+254
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align:center">
                                            ...
                                            <td class="unit text-center"><?php echo $row['product_price']?> Ksh </td>
                                            <td class="qty text-center"><?php echo $row['quantity']?></td>
                                            <td class="total text-left"><?php echo $total_per_item ?> Ksh
                                            </td>
                                        </tr>
                                        <?php $Sr++; } ?>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $total; $tax = $total * 0.07 // 5% of total ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="2"></td>
                                ...
                                <div class="d-flex "><span style="text-align:center">Payment Status :
                                        <?php echo $payment_status?></span></div>
                                <div class="thanks">Thank you!</div>

                            </main>
                            <footer>Feel free to come back and shop with us.
                            </footer>
                        </div>
